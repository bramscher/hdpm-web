...
const POSTS: BlogPostData[] = [
  ...
  {
    title: 'Predictive Maintenance: The AI Capability We\'re Building Next',
    slug: 'ai-predictive-maintenance-prevent-problems-before-they-start',
    author: 'Craig Bramscher',
    publishedAt: '2026-03-14T09:00:00.000Z',
    categorySlug: 'technology-innovation',
    tags: ['AI', 'Predictive Maintenance', 'Property Owners', 'Roadmap'],
    imageIndex: 7,
    seoTitle: 'Predictive Maintenance: HDPM\'s Next AI Capability | HDPM',
    seoDescription: 'Predictive maintenance analytics is the next AI capability on HDPM\'s roadmap. Learn how data-driven property management will help Central Oregon owners prevent expensive surprises.',
    body: richText([
      ...
      paragraph('Predictive maintenance analytics is the next AI capability on HDPM\'s roadmap — using data we already collect to identify maintenance issues before they become emergencies. This post is a preview of what we\'re building, not a description of a service that\'s live today. Our current maintenance model is proactive and scheduled; predictive analytics will layer on top of that to make it sharper.'),
      heading('How Predictive Maintenance Will Work'),
      paragraph('Every property in our portfolio generates data: maintenance history, inspection reports, equipment ages, seasonal patterns, and tenant-reported conditions. The predictive model we\'re developing will analyze this data to identify properties and systems that are statistically likely to need attention in the near future.'),
      paragraph('A furnace that\'s 15 years old, was serviced last in 2023, and sits in a property with a history of heating complaints would be a strong candidate for proactive replacement before it fails on the coldest night of the year. A roof that\'s approaching 20 years in Central Oregon\'s harsh UV and freeze-thaw environment would be flagged for inspection before the leaks start.'),
      heading('Pattern Recognition Across the Portfolio'),
      paragraph('One of the advantages of managing hundreds of doors across Central Oregon is the dataset. We see patterns that individual property owners can\'t. When a specific water heater model begins failing across multiple properties at the 8-year mark, a predictive model will be able to identify the trend and recommend proactive replacement for every property with that model — before owners experience unexpected failures.'),
      paragraph('The same logic will apply to appliances, HVAC systems, plumbing fixtures, and roofing materials. Our portfolio-wide data is the foundation we\'re building the predictive system on top of — turning anecdotal experience into statistically informed decision-making.'),
      heading('Seasonal Predictive Alerts'),
      paragraph('Central Oregon\'s dramatic seasonal shifts create predictable maintenance patterns. The planned system will generate seasonal alerts customized to each property: winterization reminders in October, irrigation system activation in April, gutter cleaning before fall rains, and defensible space assessment before fire season. These won\'t be generic calendar reminders — they\'ll be prioritized based on the specific property\'s history, configuration, and risk profile.'),
      ...
      paragraph('Our goal with predictive maintenance is to reduce emergency work orders, lower average repair costs, and extend equipment lifespans across the portfolio — converting expensive surprises into planned line items.'),
      heading('What Owners Will See'),
      paragraph('When the predictive system identifies a maintenance opportunity, owners will receive a clear recommendation: what we\'ve identified, why it matters, what the proactive cost is, and what the likely emergency cost would be if deferred. The decision will always be yours, but the information will be complete and data-driven.'),
      paragraph('This is property management that thinks ahead instead of reacting. It\'s what AI will make possible, and it\'s where HDPM is headed next. If you want to be one of the first owners on the system when it rolls out, let us know.'),
    ]),
  },
  {
    ...
    body: richText([
      ...
      paragraph('Every technology decision at HDPM starts with one question: does this make a measurable difference for owners or tenants? We don\'t deploy technology for its own sake. We deploy it because AI maintenance triage reduces emergency costs. Because automated showing scheduling fills vacancies faster. Because real-time owner reporting replaces end-of-month guesswork with live data. Every tool earns its place.'),
      ...
      paragraph('Our technology stack includes AI-powered maintenance triage that operates 24/7, automated showing scheduling that responds to prospects instantly, self-guided tour infrastructure with smart access controls, real-time owner reporting dashboards, and a tenant communication platform that eliminates wait times and voicemail. Predictive maintenance analytics is the next capability on our roadmap and is currently in development — not yet live across the portfolio.'),
  ...
  },
  {
    ...
    body: richText([
      ...
      paragraph('We\'ve been building for this future for years. Our core AI systems are already operational — not on a roadmap, not in beta, but live and producing results across hundreds of managed doors in Central Oregon. We\'re investing continuously in new capabilities — including predictive maintenance analytics that are currently in development — because we believe the property managers who embrace AI today will define the industry standard tomorrow.'),
