...
const AREAS = [
  ...
  },
  {
    ...
    population: 4000,
    medianRent: 1500,
    heroImageUrl: 'https://images.unsplash.com/photo-1687451223552-c7afa980bdad?w=1920&q=80',
    imageAlt: 'Mt. Bachelor reflected in a lake near La Pine, Oregon',
    seoTitle: 'Property Management in La Pine, Oregon',
    seoDescription: 'Property management in La Pine, OR. High Desert Property Management provides full-service rental management for La Pine property owners.',
    description: [
      "La Pine is a peaceful community surrounded by towering ponderosa pine forests in the southern reaches of Deschutes County. Known as the gateway to Newberry Volcanic Monument, La Pine offers residents an affordable entry point to the Central Oregon lifestyle with easy access to fishing, hiking, snowmobiling, and some of the region's most beautiful natural areas.",
      "The La Pine rental market appeals to tenants who value space, affordability, and a rural feel while still being within commuting distance of Bend and Sunriver. Properties on larger lots with natural surroundings are especially popular.",
      'High Desert Property Management understands the unique characteristics of the La Pine rental market. From cabin-style homes to newer construction, we manage properties with the care and attention your investment deserves.',
    ],
    highlights: [
