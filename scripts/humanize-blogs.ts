...
const UPDATED_POSTS: Record<string, ReturnType<typeof richText>> = {
  ...
  'ai-predictive-maintenance-prevent-problems-before-they-start': richText([
    ...
    paragraph('Predictive maintenance analytics is the next AI capability on HDPM\'s roadmap. It uses data we already collect to spot maintenance issues before they turn into emergencies. To be clear: this post is a preview of what we\'re building, not a description of a service that\'s live today. Our current maintenance model is proactive and scheduled. Predictive analytics will layer on top of that to make it sharper.'),
    heading('How Predictive Maintenance Will Work'),
    paragraph('Every property in our portfolio generates data: maintenance history, inspection reports, equipment ages, seasonal patterns, and conditions reported by tenants. The predictive model we\'re developing will crunch all of it to flag properties and systems that are statistically likely to need attention soon.'),
    paragraph('A furnace that\'s 15 years old, was last serviced in 2023, and sits in a property with a history of heating complaints would be a strong candidate for proactive replacement before it dies on the coldest night of the year. A roof approaching 20 years in Central Oregon\'s harsh UV and freeze-thaw conditions would be flagged for inspection before leaks start showing up.'),
    heading('Pattern Recognition Across the Portfolio'),
    paragraph('Managing hundreds of doors across Central Oregon gives us a real data advantage. We spot patterns that individual owners can\'t. When a specific water heater model begins failing across multiple properties at the 8-year mark, a predictive model will be able to catch the trend and recommend proactive replacement for every property running that model, before owners face unexpected failures.'),
    paragraph('The same logic will apply to appliances, HVAC systems, plumbing fixtures, and roofing materials. Our portfolio-wide data is the foundation we\'re building the predictive system on top of — turning guesswork into statistically informed decisions.'),
    heading('Seasonal Predictive Alerts'),
    paragraph('Central Oregon\'s big seasonal swings create predictable maintenance windows. The planned system will generate alerts customized to each property: winterization reminders in October, irrigation activation in April, gutter cleaning before fall rains, defensible space assessment before fire season. These won\'t be generic calendar pings. They\'ll be prioritized based on the property\'s specific history, configuration, and risk level.'),
    ...
    paragraph('Our goal with predictive maintenance is fewer emergency work orders, lower average repair costs, and longer equipment lifespans across the portfolio — turning expensive surprises into planned budget items.'),
    heading('What Owners Will See'),
    paragraph('When the predictive system identifies a maintenance opportunity, you\'ll get a clear recommendation: what we found, why it matters, what the proactive cost would be, and what the likely emergency cost would be if you wait. The decision will always be yours, but you\'ll have complete, data-backed information to make it.'),
    paragraph('This is property management that plans ahead instead of reacting. It\'s what AI will make possible, and it\'s where HDPM is headed next. If you\'d like to be among the first owners on the system when it rolls out, let us know.'),
  ]),
  ...
  'hdpm-central-oregon-most-innovative-property-management': richText([
    ...
    paragraph('Every technology decision at HDPM starts with one question: does this make a measurable difference for owners or tenants? We don\'t adopt tech for its own sake. We adopt it because AI maintenance triage cuts emergency costs. Because automated showing scheduling fills vacancies faster. Because real-time owner reporting replaces end-of-month guesswork with live data. Every tool has to earn its spot.'),
    ...
    paragraph('Our tech stack includes AI-powered maintenance triage that runs 24/7, automated showing scheduling that responds to prospects instantly, self-guided tour infrastructure with smart access controls, real-time owner dashboards, and a tenant communication platform that eliminates wait times and voicemail loops. Predictive maintenance analytics is the next capability on our roadmap and is currently in development — not yet live across the portfolio.'),
    paragraph('None of these systems work in isolation. They\'re connected. Maintenance data will feed the predictive models we\'re building. Showing data informs pricing recommendations. Tenant communication patterns reveal satisfaction trends. The whole system is more useful than any individual piece.'),
    heading('The Central Oregon Advantage'),
    paragraph('Central Oregon is home for us. We manage hundreds of doors across Bend, Redmond, Sisters, Prineville, Madras, and the surrounding communities. Our AI systems are trained on local data: Central Oregon rental markets, weather patterns, tenant demographics, and contractor networks. A national company running generic AI can\'t match the local accuracy of a system built specifically for this market.'),
  ...
  'future-of-property-management-ai-automation-rental': richText([
    ...
    paragraph('Predictive maintenance is the next AI capability on our roadmap — using portfolio data to flag equipment risk before failure. From there, prediction will extend to every part of property management. Which tenants are likely to renew? What rent level maximizes both occupancy and revenue? When does a property need capital improvements to stay competitive? What market conditions will impact your investment next quarter?'),
    ...
    paragraph('We\'ve been building for this future for years. Our core AI systems are live and producing results across hundreds of managed doors in Central Oregon. Not on a roadmap. Not in beta. In production. Other capabilities — like predictive maintenance analytics — are currently in development. We invest continuously in new capabilities because we believe the property managers who embrace AI now will define the industry standard going forward.'),
