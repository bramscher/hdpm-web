 ...
 * `className` (e.g. `w-full`) to fit the surrounding layout. Always shows
 * the dialable number as text so people whose device can't place a tel:
 * call (no FaceTime/calling app) can still read and dial it.
 */
