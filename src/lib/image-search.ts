/**
 * License-safe image search: Wikimedia Commons (no key) and Unsplash
 * (requires UNSPLASH_ACCESS_KEY). Shared by the admin Image Browser API
 * and the blog-agent featured-image step.
 */
...
export async function searchWikimedia(query: string, page: number): Promise<SearchResult[]> {
